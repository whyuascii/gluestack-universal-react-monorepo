...
export function AuthVerifyEmail({
  ...
  const body = i18n_body || "Please verify your email address by clicking the button below.";
  const cta = i18n_cta || "Verify Email";
  const ignore =
    i18n_ignore || "If you didn't create an account, you can safely ignore this email.";
