...
- ✅ Web (Next.js) - `i18n/web`
- ✅ Mobile (React Native) - `i18n/mobile`
...
```json
{
  "newFeature": {
    "title": "Nueva Función",
    "description": "¡Mira nuestra nueva función!"
  }
}
```
...
- ✅ Use descriptive keys: `auth.signIn`, `common.buttons.save`
- ✅ Group related translations: `common.buttons.*`, `auth.errors.*`
- ✅ Use camelCase for keys: `emailAddress`, `passwordReset`

**DON'T:**

- ❌ Use sentences as keys: `"Sign In"` ← use `auth.signIn`
...
- ❌ Hardcode English in components
...
- ✅ Keep common UI strings in `common.json`
- ✅ Create new files for large feature areas
- ✅ Keep parallel structure across languages

**DON'T:**

- ❌ Put everything in one file
- ❌ Mix different domains in same file
- ❌ Create files that only have 2-3 keys
