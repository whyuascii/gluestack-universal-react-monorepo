...
export function AuthResetPassword({
  ...
  const cta = i18n_cta || "Reset Password";
  const expiry = i18n_expiry || `This link will expire in ${expiresIn}.`;
  const ignore =
    i18n_ignore || "If you didn't request a password reset, you can safely ignore this email.";
