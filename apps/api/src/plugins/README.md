...
Plugins define behavior that is common to all the routes in Node Core. Authentication, caching, templates, and all the other cross cutting concerns should be handled by plugins placed in this folder. INCLUDING decorators.
