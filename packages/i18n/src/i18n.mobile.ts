 ...
 * 1. User preference (stored in AsyncStorage when user sets preference)
 * 2. Device detected language (Localization.getLocales())
 * 3. Default English (fallback)
 *
 * When user logs in, call i18n.changeLanguage(user.preferredLanguage)
 * to apply their account preference, which gets cached in AsyncStorage.
 */
i18n
